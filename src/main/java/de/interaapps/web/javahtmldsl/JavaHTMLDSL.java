...
public class JavaHTMLDSL {
    ...
    public static String html(DomElementEditor elementEditor, String ...contents){
        return "<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 4.01//EN\">"+elementEditor.edit(new DomElement("html").html(String.join("", contents))).build();
    }
    ...
    public static String body(DomElementEditor elementEditor, String ...contents){
        return elementEditor.edit(new DomElement("body").html(String.join("", contents))).build();
    }
    ...
    public static String head(DomElementEditor elementEditor, String ...contents){
        return elementEditor.edit(new DomElement("head").html(String.join("", contents))).build();
    }
    ...
    public static String p(DomElementEditor elementEditor, String ...contents){
        return elementEditor.edit(new DomElement("p").html(String.join("", contents))).build();
    }
    ...
    public static String div(DomElementEditor elementEditor, String ...contents){
        return elementEditor.edit(new DomElement("div").html(String.join("", contents))).build();
    }
    ...
    public static String ul(DomElementEditor elementEditor, String ...contents){
        return elementEditor.edit(new DomElement("ul").html(String.join("", contents))).build();
    }
    ...
    public static String ol(DomElementEditor elementEditor, String ...contents){
        return elementEditor.edit(new DomElement("ol").html(String.join("", contents))).build();
    }
    ...
    public static String li(DomElementEditor elementEditor, String ...contents){
        return elementEditor.edit(new DomElement("li").html(String.join("", contents))).build();
    }
